...
municipality x year x month for monthly PM2.5 tables, and the best available
municipal time grid for daily-reference tables.
...
timestamped reports, checksums, coverage tables, and missing-municipality lists
under `data-raw/rj-download-completeness-output/`. These generated files are
intended to be archived with a release or local validation record, not committed
as package data.
